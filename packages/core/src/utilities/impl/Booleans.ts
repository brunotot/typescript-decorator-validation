 ...
 * @typeParam T - The type to check.
 */
export type isFunction<T> = NonNullable<T> extends Types.FunctionType
  ? Types.UnwrapPromise<ReturnType<NonNullable<T>>> extends API.Validation.ValidationResult
    ? true
    : false
  : false;
