 ...
 */
export function hasErrors<T>(data: API.Strategy.Impl.Errors<T>): boolean {
...
export function toClass<const TClass extends Types.Class<any>>(
  ...
  function _toClass<const TConstructor extends Types.Class<any>>(
    clazz: TConstructor,
    object?: Payload<Types.UnwrapClass<TConstructor>> | Types.ArrayType
    ...
    const data: API.Decorator.DecoratorArgs = {};
