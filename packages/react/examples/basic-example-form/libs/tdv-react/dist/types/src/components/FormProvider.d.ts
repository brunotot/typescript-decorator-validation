...
export declare const FormContext: React.Context<Omit<FormProviderProps, "children"> | undefined>;
 ...
 * ```
 */
export declare function FormProvider({ children, submitted, setSubmitted, validateImmediately }: FormProviderProps): React.JSX.Element;
