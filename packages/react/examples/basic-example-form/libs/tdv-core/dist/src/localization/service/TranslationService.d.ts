...
import { LocalizedMessages } from "../service/MessageReaderService";
/**
 ...
 * ```
 */
export declare function translate(locale: Locale | null | undefined, key: keyof LocalizedMessages, ...args: any[]): string;
