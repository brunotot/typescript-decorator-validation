 ...
 */
export type ClassDecorator<TClass extends Types.Class> = ((baseClass: TClass, context: ClassDecoratorCtx<TClass>) => TClass | undefined | void) & {};
/**
 ...
 */
export type ClassDecoratorSupplier<TClass extends Types.Class> = ((meta: ClassValidatorMetaService<TClass>, baseClass: TClass, context: ClassDecoratorCtx<TClass>) => TClass | undefined | void) & {};
/**
 ...
 */
export declare function createClassDecorator<TClass extends Types.Class>(supplier: ClassDecoratorSupplier<TClass>): ClassDecorator<any>;
