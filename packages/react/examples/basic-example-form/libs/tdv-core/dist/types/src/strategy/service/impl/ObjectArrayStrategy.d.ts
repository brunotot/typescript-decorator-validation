...
import { type DetailedErrorsResponse, type SimpleErrorsResponse } from "../../models";
...
export declare namespace ObjectArrayStrategy {
    /**
     ...
     */
    type matches<T, K extends keyof T> = Arrays.getArrayType<NonNullable<T[K]>> extends never ? false : true extends Booleans.isGetter<T, K> ? false : Booleans.isObject<Arrays.getArrayType<NonNullable<T[K]>>>;
    /**
