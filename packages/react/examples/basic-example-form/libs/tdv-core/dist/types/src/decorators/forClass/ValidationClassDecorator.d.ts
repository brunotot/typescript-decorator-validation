 ...
 * ```
 */
export declare function build<T extends API.Decorator.ForClass.Basic.Scope>(validate: API.Validation.Evaluator<API.Utilities.Types.UnwrapClass<T>>, groups?: string[]): API.Decorator.ForClass.Basic.Instance<T>;
//# sourceMappingURL=ValidationClassDecorator.d.ts.map