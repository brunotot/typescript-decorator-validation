 ...
 */
export declare class ClassValidatorMetaService<TStrategy extends API.Reflection.MetaStrategy> extends AbstractMetaService<API.Reflection.Rule.Instance<any>> {
    /**
     ...
     */
    static inject<T extends API.Reflection.MetaStrategy>(strategy: T): ClassValidatorMetaService<API.Utilities.Types.UnwrapMetaStrategy<T>>;
    private constructor();
    /**
     ...
     */
    addValidator(isValid: API.Validation.Evaluator<API.Utilities.Types.UnwrapClass<TStrategy>>, groups: string[]): void;
}
