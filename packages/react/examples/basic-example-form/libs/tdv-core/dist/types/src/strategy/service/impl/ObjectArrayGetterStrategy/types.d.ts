 ...
 */
declare namespace ObjectArrayGetterStrategyType {
    /**
     ...
     */
    type matches<T, K extends keyof T> = true extends API.Utilities.Booleans.isGetter<T, K> ? API.Utilities.Arrays.getArrayType<NonNullable<T[K]>> extends never ? false : API.Utilities.Booleans.isObject<API.Utilities.Arrays.getArrayType<NonNullable<T[K]>>> : false;
    /**
