...
export declare function isNumericValid<T extends API.Utilities.Objects.Optional<string>>(
  value: T
): boolean;
/**
 ...
 * ```
 */
export declare function Numeric<T extends API.Utilities.Objects.Optional<string>>(
