 ...
 */
declare namespace StrategyFactory {
    /**
     ...
     */
    type evaluate<T, R = undefined> = true extends API.Utilities.Booleans.isUndefined<R> ? API.Utilities.Types.Prettify<API.Utilities.Objects.Purify<evaluateOptional<T, R>>> : API.Utilities.Types.Prettify<API.Utilities.Objects.Purify<evaluateMandatory<T, R>>>;
    /**
     * Type for optional evaluation of each field in a type.
     * @typeParam T - The type to evaluate.
     * @typeParam R - The result type.
     */
    type evaluateOptional<T, R> = {
