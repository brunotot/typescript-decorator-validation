import { type FunctionStrategy, type ObjectArrayGetterStrategy, type ObjectArrayStrategy, type ObjectGetterStrategy, type ObjectStrategy, type PrimitiveArrayGetterStrategy, type PrimitiveArrayStrategy, type PrimitiveGetterStrategy, type PrimitiveStrategy } from "../service/impl";
