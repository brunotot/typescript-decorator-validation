 ...
 */
declare namespace ClassDecoratorValidatorService {
    /**
     ...
     */
    type Supplier<T extends API.Decorator.Service.ClassDecoratorService.Type> = {
     ...
     */
    type Evaluator<T extends API.Decorator.Service.ClassDecoratorService.Type> = ((value: any, context: API.Decorator.Service.ClassDecoratorService.Context<T>, locale: API.Localization.Resolver.LocaleResolver.Locale) => API.Validation.Result) & {};
    /**
     ...
     * ```
     */
    function build<T extends API.Decorator.Service.ClassDecoratorService.Type>(validate: API.Validation.Evaluator<T>, options?: API.Decorator.Options): API.Decorator.Service.ClassDecoratorService.Instance<T>;
}
export default ClassDecoratorValidatorService;
//# sourceMappingURL=ClassDecoratorValidatorService.d.ts.map