...
declare namespace Objects {
     ...
     */
    type Payload<T> = Types.Prettify<API.Utilities.Objects.Purify<{
        [K in keyof T]: true extends Booleans.isAnyOf<true, [
            Booleans.isGetter<T, K>,
            Booleans.isFunction<T[K]>
        ]> ? never : true extends Booleans.isArray<T[K]> ? true extends Booleans.isPrimitive<Arrays.getArrayType<T[K]>> ? Arrays.setArrayDepth<Arrays.getArrayType<T[K]>, Arrays.getArrayDepth<T[K]>> : Arrays.setArrayDepth<Payload<Arrays.getArrayType<T[K]>>, Arrays.getArrayDepth<T[K]>> : true extends Booleans.isPrimitive<T[K]> ? T[K] : Payload<T[K]>;
    }>>;
    /**
     ...
     */
    type Purify<T> = Objects.Exclude<T, never>;
    /**
     ...
     */
    function hasErrors<T>(data: API.Strategy.Factory.Impl.Errors<T>): boolean;
    /**
     ...
     */
    function toClass<const TClass extends Types.Class<any>>(clazz: TClass, object?: Payload<Types.UnwrapClass<TClass>>): Types.UnwrapClass<TClass>;
    /**
