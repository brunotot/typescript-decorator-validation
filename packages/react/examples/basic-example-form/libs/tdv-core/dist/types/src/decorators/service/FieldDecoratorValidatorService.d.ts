 ...
 */
declare namespace FieldDecoratorValidatorService {
    /**
     ...
     * ```
     */
    function build<T extends API.Decorator.Service.FieldDecoratorService.Type>(validate: API.Validation.Evaluator<T>, groups?: string[]): API.Decorator.Service.FieldDecoratorService.Instance<T>;
}
export default FieldDecoratorValidatorService;
//# sourceMappingURL=FieldDecoratorValidatorService.d.ts.map